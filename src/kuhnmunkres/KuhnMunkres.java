...
class KuhnMunkres {
    ...
    public void init() {
        ...
        this.mAumenting = new int[originalG.get_m_WeightMatrix().length]; //camino aumentante [empieza y termina con no saturado]

        this.mLabeling.InitialLabeling(this.originalG);//labeling rows Max number; labeling columns 0
